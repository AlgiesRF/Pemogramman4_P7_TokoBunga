...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("TOKO BUNGA ALGIES");
        ...
        btnProses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tvNamaBarang.setText("Jenis Bunga : " + namaBarang);
                tvJmlBarang.setText("Jumlah Bunga : " + jumlahBarang);
                tvHarga.setText("Harga Bunga : " + hargaBarang);
                tvUangBayar.setText("Uang bayar : " + uangBayar);

                tvTotal.setText("Total Pembelian " + total);
                if (total >= 200000) {
                    tvBonus.setText("Bonus : Satu Jepit Bunga");
                } else if (total >= 50000) {
                    tvBonus.setText("Bonus : Satu Tangkai Bunga Mawar");
                } else if (total >= 40000) {
                    tvBonus.setText("Bonus : Satu Buket Bunga");
                } else {
